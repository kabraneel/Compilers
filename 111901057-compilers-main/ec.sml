...
val _           = TextIO.output(TextIO.stdErr, "IR PRETTY PRINT\n")
val _           = TextIO.output(TextIO.stdErr, IR.pp executable)
val _           = TextIO.output(TextIO.stdOut, MIPS.printProg executable)
val _           = TextIO.output(TextIO.stdErr, "\n BASIC BLOCKS \n")
val _           = TextIO.output(TextIO.stdErr, MIPSBasicBlock.printblock (MIPSBasicBlock.basicBlocks(executable)))
